...
public class ConvertirMonedas {
	...
	public void ConvertirpesosArupia(double valor) {
		double Monedarupia = valor / 48.44;
		Monedarupia = (double) Math.round(Monedarupia * 100d) / 100;
		JOptionPane.showMessageDialog(null, "Tienes $" + Monedarupia + "rupias");
